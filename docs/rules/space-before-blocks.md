...
The following patterns are considered warnings when configured `{ "functions": "never", "keywords": "always" }`:
...
The following patterns are not considered warnings when configured `{ "functions": "never", "keywords": "always" }`:
...
The following patterns are considered warnings when configured `{ "functions": "always", "keywords": "never" }`:
...
The following patterns are not considered warnings when configured `{ "functions": "always", "keywords": "never" }`:
